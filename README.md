...
> [!IMPORTANT]
> Возможно, что в списках шефов вы будет не в той группе, это норма. Главное смотрите своего шефа, вашу группу потом уточнят. Списки периодически обновляются, так что мониторьте.
...
Каждое заданиие на свою тему: 
1. Условные
1. Циклы с конечным числом повторений
1. Циклы с условием
1. Массивы

Запрещены функции/процедуры, записи, файлы. Если не уверены, можно ли пользоваться чем-то, то переспросите. Все равно это всплывет, из-за этого можно отлететь на переделывание. На первую задачу второго блока это тоже распространяется.
