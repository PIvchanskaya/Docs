...
### Система шефов
Если кратко, то старшие учат младших. Есть шефы-старшекурсники и подшефные-первокурсники. За каждым шефом закреплено до 3 подшефных. Своего шефа узнать можно из [списка](Docs/шефы.xlsx). 
...
ДЗ выдается в виде [задачек на алгоритмы](Docs/задачи.docx) и делается в виде блок-схем, затем сдается в тетрадях на проверку. На дз забивать не стоит, Г.В. за это будет отчитывать и дизреспектовать.
